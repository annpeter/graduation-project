 ...
 */
public class PaginationBatchExecutor extends BatchExecutor implements PaginationBaseExecutor {
    private Dialect dialect;

    public PaginationBatchExecutor(DB_Type dbType, Configuration configuration, Transaction transaction) {
