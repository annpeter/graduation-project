...
import cn.annpeter.graduation.project.base.restful.rpc.utils.HttpServiceValidateUtils;
...
public class MethodInvoke implements MethodInterceptor {
    ...
    public Object create() throws Exception {
        ...
        if (processor == null) {
            throw new NoSuchBeanDefinitionException(targetClass, "can't be initialize");
        }
