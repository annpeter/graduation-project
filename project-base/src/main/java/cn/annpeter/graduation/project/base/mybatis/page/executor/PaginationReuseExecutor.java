 ...
 */
public class PaginationReuseExecutor extends ReuseExecutor implements PaginationBaseExecutor {
    private Dialect dialect;

    public PaginationReuseExecutor(DB_Type dbType, Configuration configuration, Transaction transaction) {
